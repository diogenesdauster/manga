...
import br.com.dauster.manga3.Adapter.ViewPagerBottomNavigationAdapter;
...
public class MangasMainListAllFragment extends Fragment implements SearchView.OnQueryTextListener,
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new MangaMainListAllAdapter(getActivity(),mMangasList);
        mAdapter.setmMangaClickListener(new MangaMainListAllAdapter.OnMangaClickListener() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewPagerBottomNavigationAdapter mBtNavAdapter = new
                ViewPagerBottomNavigationAdapter(getActivity().getSupportFragmentManager());
